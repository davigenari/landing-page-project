...
Envie os dados para simulação de contato;
Visualize validações básicas no frontend.
Os dados não são armazenados nem enviados para um servidor. O formulário é apenas demonstrativo.

The contact form allows users to:

Enter name, email, and message
Submit the form as a contact simulation
...
Organizar arquivos front-end
Organize front-end files
